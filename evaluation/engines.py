...
class OCREngine:
    ...
    def process_answer(self, answer):
        ...
        try:
            ...
            ocr_eval, created = OCREvaluation.objects.get_or_create(
                answer=answer,
                defaults={
                    'extracted_text': '',
...
class NLPEngine:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.info("NLTK stopwords unavailable; using built-in fallback list")
    ...
    def evaluate_answer(self, answer):
        ...
        try:
            nlp_eval, _ = NLPEvaluation.objects.get_or_create(
                answer=answer,
                defaults={
                    'text_similarity': 0.0,
